...
//Entidade da camada de entidade
...
//entidade da entidade que possui os dados do usuario
//retirado o setCreatedAt
public class User {
    private UUID id;
    private String emain;
    private String password;
    private TaxNumber taxNumber; //numero de identificador fiscal, CPF ou CNPJ
    ...
    public User(UUID id, String emain, String password, TaxNumber taxNumber, String fullname,
                UserTypeEnum type, TransactionPin transactionPin, LocalDateTime createdAt,
    ...
    public User(String emain, String password, TaxNumber taxNumber, String fullname,
                UserTypeEnum type, TransactionPin transactionPin) {
        this.emain = emain;
        this.password = password;
        this.taxNumber = taxNumber;
        this.fullname = fullname;
