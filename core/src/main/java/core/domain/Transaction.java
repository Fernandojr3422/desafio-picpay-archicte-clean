...
//Class que vai possuir os dados da transação do usuário
...
public class Transaction {
    ...
    public Transaction(Long id, Wallet fromWallet, Wallet toWallet, BigDecimal value,
                       TransactionStatusEnum status, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
