...
//class de numero de identificador fiscal
//as validações vão ficar aqui dentro ,
// ate para verificar se um numero de CPF ou CNPJ ESTA VINDO dentro do TaxNumber.
